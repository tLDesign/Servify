...
public class Grub extends ApplicationController {
    ...
    private Entity createDemoMainWindowEntity(Entity accountEntity){
        ...
        if (accountEntity == null){
             account = new AccountModel();
            account.set(Account.firstName, "Tomás");
            account.set(Account.lastName, "Arce");
            account.set(Account.emailAddress, "tomitoarce@gmail.com");
            account.set(Account.password, "Rustpapanata123_");
            account.set(Account.mobileNumber, "Rustpapanata123_");
        }else{
        ...
        for (int i = 0; i < 5; i++){
            ...
            restaurantsList.add(createRestaurantDemoModel2());
    ...
    private Entity createRestaurantDemoModel(){
    	...
    	RestaurantModel medra = new RestaurantModel("Medra Studio", "https://raw.githubusercontent.com/tLDesign/Servify/main/medra.png", "Barbería", 4.7, 5, "https://raw.githubusercontent.com/tLDesign/Servify/main/medra.png",30, createDemoMenu());
    ...
    private Entity createRestaurantDemoModel2(){
        
    	RestaurantModel luigis = new RestaurantModel("Ayerza", "https://raw.githubusercontent.com/tLDesign/Servify/main/Ayerza.jpeg", "Restaurante", 4.2, 5, "https://raw.githubusercontent.com/tLDesign/Servify/main/Ayerza.jpeg",22, createDemoMenu());
