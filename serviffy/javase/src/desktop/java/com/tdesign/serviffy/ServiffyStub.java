 ...
 * @author Shai Almog
 */
public class ServiffyStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Serviffy";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ServiffyStub());
    }
